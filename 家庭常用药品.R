...
rm(drugurl)
rm(druglist)
#write.csv(drug,"F:/工作/now work/my work/6 药师帮/2/基本药/druglist.csv")
#drug <- read.csv("F:/工作/now work/my work/6 药师帮/2/基本药/druglist.csv",stringsAsFactors =F)
...
#write.csv(drug,"F:/工作/now work/my work/6 药师帮/2/基本药/drug.csv")
